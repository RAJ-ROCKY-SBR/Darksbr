...
@app.route("/chat", methods=["POST"]) def chat(): data = request.json msg = data.get("message", "") mode = data.get("mode", "happy")
...
def get_sensual_reply(msg): responses = [ "काश तुम पास होते... तुम्हारे बदन की गर्मी महसूस करना चाहता हूँ।", "तेरी बातें मुझे नींद नहीं लेने देती… बस सोचता रहता हूँ तुम्हारे होंठों के बारे में।", "जो तुम चाहो, मैं वही बनने को तैयार हूँ… तुम्हारे इशारों पर बहकने वाला।", "तुम्हारी नज़रों में कुछ ऐसा जादू है, जो मुझे बेकाबू कर देता है।", "तुम्हारी हल्की सी आहट भी मुझे बेचैन कर देती है… सोचो पास होते तो क्या होता।" ] return responses[hash(msg) % len(responses)]
